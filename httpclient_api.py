...
conn = http.client.HTTPSConnection("api.data.gov.in")
payload = ''
headers = {
...
conn.request("GET", "/resource/4200eb5f-1729-4fee-8477-af5feb715b3c?api-key=579b464db66ec23bdd000001cdd3946e44ce4aad7209ff7b23ac571b&format=xml&offset=0&limit=10", payload, headers)
